...
import { TwoColumnComponent, FirstColumn, SecondColumn } from "@components/layout/TwoColumnComponent";
...
export function MemberSetting({setIsParent, roomId, setRoomId, voice, setVoice, voices, setVoices}: MemberSettingProps) {
  return <>
    <VStackChildren>
